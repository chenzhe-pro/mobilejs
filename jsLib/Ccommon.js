//common组件类库，基于jquery，使用前请引用jquery
(function(){
    function common()
    {
        ...
        this.alert=function(alertStr,type,call) {
            var obj=this,alert_elem,alert_elemstr,fun=call;
            if($(".common_alert")[0]) {
            ...
            else
            {
                ...
                else
                {
                    if(type==2)
                    {
                        ...
                        $(".common_alert")[0].style.cssText="  box-shadow: 0px 0px 8px 3px #999;width:220px;padding:15px;position: fixed;z-index:1000;top:40%;border-radius: 6px 6px;text-align: center;background-color: #fff;color:#2d2d2d;";
        ...
        this.dateTimePicker=function(jqelem,obj)
        {
            var css=document.createElement("link");
            css.rel="stylesheet";
            css.href="/static/public/css/common.datetimepicker.css";
            $('head').append(css);
            (function ($) {
                'use strict';
                var default_options  = {
                    ...
                    createDateTimePicker = function (input) {
                        ...
                        setPos = function () {
                            ...
                            do {
                                ...
                                {
                                    if(node.currentStyle['position'] === 'relative' && $(window).width() >= node.offsetWidth) {
                                        left = left - (($(window).width() - node.offsetWidth)/2)
                                        break
                                    }
                                }
